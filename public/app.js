      ...
      <div class="hm-card">
        ...
        <div style="display:flex;align-items:center;gap:20px;padding:16px">
          ...
          <div>
            ...
            <div style="font-size:10px;color:var(--t3);margin-top:4px">${data.paper_metrics?.macro_f1?"Macro-F1: "+data.paper_metrics.macro_f1+" · AUC: "+data.paper_metrics.auc:"C_t = 5 threat classes"}</div>
          </div>
        </div>
      </div>
      <div class="hm-card">
